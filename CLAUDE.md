...
Motor de autorización driver-based para AdonisJS 7 + Lucid. Paquete npm publicado (`2.4.0-alpha.1`,
2026-09-01; en el árbol, `2.4.0-alpha.2` sin release: `package.json` lo sube el dueño), ESM, Node ≥ 20.6. Autor: José Antonio (jantstack). Idioma de trabajo: **español**
...
13. **Una escritura que vence el deadline es indeterminada.** El manager notifica `onWrite` con
    ...
    consulta y la deja viva, SQLite no puede vencer un deadline (`SQLITE_BUSY`).
